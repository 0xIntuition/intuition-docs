...
parser.add_argument('-o', '--owner', help='Owner of the repo', default='intuition-systems')
parser.add_argument('-r', '--repo', help='Repo to fetch docs from', default='intuition-docs')
parser.add_argument('-v', '--version', help='Release version to update docs to')
parser.add_argument('-d', '--destination', help='Destination folder for reference directory', default='docs/')

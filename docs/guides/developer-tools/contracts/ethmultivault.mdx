...
*For more information about bonding curves and their implementation, see the [Bonding Curves](/guides/introduction/the-economics/bonding-curves) documentation.* 
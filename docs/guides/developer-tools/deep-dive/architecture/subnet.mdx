...
<BrowserOnly fallback={<p>Loading diagram...</p>}>
  {() => <ExcalidrawViewer src="/excalidraw/data-papeline.excalidraw.json" zoom={0.5} scrollX={-1100} scrollY={150} backgroundColor="#1b1b1d" />}
</BrowserOnly>
:::tip **Why Rust?**
...
The Subnet exposes multiple API interfaces including GraphQL, REST, and real-time subscriptions for interacting with the knowledge graph.

:::note Get more details
For detailed information about the available APIs, query examples, and interactive playgrounds, please see the **[GraphQL API Overview](/docs/developer-tools/graphql-api/overview)**.
:::

        ...
        <div key={account.id} className="account-item">
          ...
          <div>
            ...
            <div className="stats">
              ...
              • {parseFloat(account.positions_aggregate.aggregate.sum.shares).toFixed(2)} total shares
            </div>
          </div>
        </div>
      ))}
...
- [Building Activity Feeds](/docs/guides/tutorials/queries/activity-feeds) - Track user actions
- [Finding Related Claims](/docs/guides/tutorials/queries/related-claims) - Explore connections
- [Reputation System Tutorial](/docs/guides/tutorials/reputation-system) - Build reputation scoring

## Resources

- [GraphQL API Reference](/docs/guides/developer-tools/graphql-api/overview)
- [Accounts Schema](/docs/guides/developer-tools/graphql-api/schema)

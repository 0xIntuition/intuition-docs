...
sidebar_position: 9
description: Step-by-step guide to create personalized activity streams for users
---
...
- **Step 1**: Get complete user activity feed including atoms created and positions taken with vault details
- **Step 2**: Get recent claims created by user - both atoms (max 10) and triples (max 10) with detailed metadata

  ...
  return (
    <div>
      ...
      <FAQItem question="How do I get started with Intuition?">
        <div>
          <h4>Step 1</h4>
          <p>Read the Documentation: Start with the <a href="/docs/getting-started/overview">Getting Started</a> and <a href="/docs/getting-started/overview">Overview</a> guides to understand the core concepts.</p>
          
          <h4>Step 2</h4>
          <p>Connect to Intuition: Visit the <a href="https://testnet.hub.intuition.systems/">Intuition Hub</a> to access the L3 network development environment and get your development environment set up.</p>
      ...
      <FAQItem question="How do I connect to the Intuition testnet?">
        <div>
          ...
          <p>Visit the <a href="https://testnet.hub.intuition.systems/">Intuition Hub</a> at <a href="https://intuition-testnet.hub.caldera.xyz/" target="_blank" rel="noopener noreferrer">intuition-testnet.hub.caldera.xyz</a> for centralized access to all Intuition L3 network services.</p>
          ...
          <p>Access the <a href="https://testnet.hub.intuition.systems/" target="_blank" rel="noopener noreferrer">Bridge</a> for cross-chain transfers, <a href="https://testnet.explorer.intuition.systems/" target="_blank" rel="noopener noreferrer">Explorer</a> for blockchain exploration, and monitor network status through the <a href="https://testnet.hub.intuition.systems/">Hub</a>. For main network interactions, visit the <a href="https://beta.portal.intuition.systems/" target="_blank" rel="noopener noreferrer">Portal</a>.</p>
        </div>
      </FAQItem>
      ...
      <FAQItem question="How do I integrate Intuition into my existing app?">
        <div>
          ...
          <h4>Step 2</h4>
          <p>Configure Connection: Set up connection to the Intuition L3 network first using the network details from the <a href="https://testnet.hub.intuition.systems/">Hub</a>.</p>
      ...
      <FAQItem question="How do I deploy an application?">
        <div>
          ...
          <h4>Step 2</h4>
          <p>Test on Intuition: Use the <a href="https://testnet.hub.intuition.systems/">Intuition L3 network</a> to thoroughly test your application before mainnet deployment. Access all L3 services through the hub.</p>
      ...
      <FAQItem question="What are the best practices for building with Intuition?">
        <div>
          ...
          <p><strong>Test Extensively</strong>: Use the <a href="https://testnet.hub.intuition.systems/">Intuition L3 network</a> for all development and testing to avoid costly mistakes. Access the full L3 infrastructure through the hub.</p>
          <p><strong>Follow Security Guidelines</strong>: Implement proper security measures and follow established patterns. Review our <a href="/docs/intuition-smart-contracts/audit-reports">security audits</a> for best practices.</p>
          <p><strong>Document Your Code</strong>: Maintain clear documentation for your applications to help other developers.</p>
          <p><strong>Monitor Applications</strong>: Use the <a href="https://testnet.hub.intuition.systems/">Hub's monitoring tools</a> to track your application's performance and catch issues early.</p>
        </div>
      </FAQItem>
      ...
      <FAQItem question="What if I can't connect to the testnet?">
        <div>
          ...
          <p>Verify that your wallet is configured with the correct network details from the <a href="https://testnet.hub.intuition.systems/">Hub dashboard</a>. The Chain ID and RPC URL should match exactly.</p>
          
          <h4>Check Network Status</h4>
          <p>Visit the <a href="https://testnet.hub.intuition.systems/">Hub</a> to see if there are any ongoing issues with the L3 network services.</p>
      ...
      <FAQItem question="What if my transaction fails?">
        ...
        <ul>
          ...
          <li><strong>Network Issues</strong>: Check the <a href="https://testnet.hub.intuition.systems/">network status</a> for any ongoing network problems</li>
        </ul>
      </FAQItem>

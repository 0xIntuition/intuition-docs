...
sidebar_position: 10
description: A step-by-step guide to discovering related triples and relationship patterns
---
...
- **Step 1**: Find all triples where a specific atom appears as subject or object and discover direct relationships.
- **Step 2**: Find similar claims by predicate pattern and subject type, then discover relationship patterns across the graph.
- **Step 3**: Get detailed information about a specific triple, including vault metrics and top positions.

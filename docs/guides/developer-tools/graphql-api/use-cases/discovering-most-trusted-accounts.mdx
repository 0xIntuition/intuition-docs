...
sidebar_position: 7
description: Step-by-step guide to identify highly trusted accounts based on stake and activity
---
...
Learn how to use the Intuition GraphQL API to identify and rank the most trusted accounts in the ecosystem based on their positions, stakes, and activity patterns.

## Understanding the Progression

- **Step 1**: Get top 20 accounts ranked by total shares across all positions - shows the most trusted accounts based on cumulative stakes
- **Step 2**: Get detailed information for a specific account including all positions and atoms created
- **Step 3**: Find top 20 individual positions by share amount - shows which accounts hold the largest single stakes

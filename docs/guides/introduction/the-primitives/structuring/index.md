...
<a href="/docs/guides/introduction/the-primitives/structuring/atoms" style={{ color: 'var(--ifm-color-primary)', textDecoration: 'none', fontWeight: '500' }}>
...
<a href="/docs/guides/introduction/the-primitives/structuring/triples" style={{ color: 'var(--ifm-color-primary)', textDecoration: 'none', fontWeight: '500' }}>
...
<a href="/docs/guides/introduction/the-primitives/structuring/capturing-signal" style={{ color: 'var(--ifm-color-primary)', textDecoration: 'none', fontWeight: '500' }}>
...
<a href="/docs/guides/introduction/the-primitives/structuring/calculating-rewards" style={{ color: 'var(--ifm-color-primary)', textDecoration: 'none', fontWeight: '500' }}>
...
Before diving into structuring techniques, make sure you have a solid understanding of the [Fundamentals](/docs/guides/introduction/the-primitives/fundamentals) section, particularly:
...
After mastering structuring techniques, explore the [Developer Tools](/docs/guides/developer-tools) section to learn how to implement these concepts in your applications. 
...
- Uploading JSON data (uploadJsonToIpfs)
- Generating charts (getChartJson, getChartSvg)
- Fetching PnL data (getAccountPnlCurrent, etc.)
...
### Chart & Analytics Mutations

| Mutation | Description | Documentation |
|----------|-------------|---------------|
| `getChartJson` | Get chart data as JSON | [Chart JSON](/docs/graphql-api/mutations/charts/chart-json) |
| `getChartSvg` | Get chart as SVG | [Chart SVG](/docs/graphql-api/mutations/charts/chart-svg) |
| `getChartRawJson` | Get raw chart JSON | [Chart Raw JSON](/docs/graphql-api/mutations/charts/chart-raw-json) |
| `getChartRawSvg` | Get raw chart SVG | [Chart Raw SVG](/docs/graphql-api/mutations/charts/chart-raw-svg) |

### PnL (Profit & Loss) Operations

| Operation | Description | Documentation |
|-----------|-------------|---------------|
| `getAccountPnlCurrent` | Current account PnL snapshot | [Account PnL Current](/docs/graphql-api/mutations/pnl/account-pnl-current) |
| `getAccountPnlChart` | Account PnL over time | [Account PnL Chart](/docs/graphql-api/mutations/pnl/account-pnl-chart) |
| `getAccountPnlRealized` | Realized PnL breakdown | [Account PnL Realized](/docs/graphql-api/mutations/pnl/account-pnl-realized) |
| `getPositionPnlChart` | Position-level PnL | [Position PnL Chart](/docs/graphql-api/mutations/pnl/position-pnl-chart) |
...
- [PnL Operations](/docs/graphql-api/mutations/pnl/overview) - Profit & Loss tracking
- [Chart Operations](/docs/graphql-api/mutations/charts/overview) - Chart generation
- [Image Operations](/docs/graphql-api/mutations/images/overview) - Image uploads

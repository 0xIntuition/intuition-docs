...
sidebar_position: 6
description: Step-by-step guide for querying and ranking top decentralized applications on Coinbase
---
...
- **Step 1**: Run a basic query to view all dApps (organizations) in the system.
- **Step 2**: Repeate the query, but filtered for Coinbase-related Dapps (note how the results narrow down).
- **Step 3**: Add performance metrics from vaults (market cap, shares, and positions) - data is now richer but not yet sorted.
- **Step 4**: Repeate the query from Step 3, but this time sort by market cap to show the top performing dApps first.

...
The Intuition Hub provides essential tools and applications for interacting with the Intuition ecosystem. From exploring the knowledge graph to bridging assets across networks, these tools empower users and developers to fully engage with the Intuition protocol.
...
<a href="/guides/hub/explorer" style={{ textDecoration: 'none', color: 'inherit' }}>
<div style={{ border: '1px solid var(--ifm-color-emphasis-300)', borderRadius: '8px', padding: '1.5rem', backgroundColor: 'var(--ifm-background-color)' }} className="docs-card">
<div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
...
<div className="docs-card-content">
<p style={{ marginBottom: '1rem', color: 'var(--ifm-color-emphasis-700)' }}>
Block explorer for viewing transactions, blocks, and network activity on the Intuition network. Monitor network performance and verify transactions. <strong>Great for exploring</strong> - check out network activity and verify transactions.
</p>
<div className="docs-card-tags" style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
<span style={{ backgroundColor: 'var(--ifm-color-emphasis-100)', padding: '0.25rem 0.5rem', borderRadius: '4px', fontSize: '0.875rem' }}>Blocks</span>
<span style={{ backgroundColor: 'var(--ifm-color-emphasis-100)', padding: '0.25rem 0.5rem', borderRadius: '4px', fontSize: '0.875rem' }}>Transactions</span>
<span style={{ backgroundColor: 'var(--ifm-color-emphasis-100)', padding: '0.25rem 0.5rem', borderRadius: '4px', fontSize: '0.875rem' }}>Analytics</span>
</div>
</div>
</div>
</a>

<a href="/guides/hub/bridge" style={{ textDecoration: 'none', color: 'inherit' }}>
<div style={{ border: '1px solid var(--ifm-color-emphasis-300)', borderRadius: '8px', padding: '1.5rem', backgroundColor: 'var(--ifm-background-color)' }} className="docs-card">
<div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
...
<div className="docs-card-content">
<p style={{ marginBottom: '1rem', color: 'var(--ifm-color-emphasis-700)' }}>
Cross-chain bridge for transferring assets between different networks and the Intuition ecosystem. Secure multi-chain functionality. <strong>Essential for cross-chain access</strong> - transfer assets between networks securely.
</p>
<div className="docs-card-tags" style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
<span style={{ backgroundColor: 'var(--ifm-color-emphasis-100)', padding: '0.25rem 0.5rem', borderRadius: '4px', fontSize: '0.875rem' }}>Cross-chain</span>
...
<span style={{ backgroundColor: 'var(--ifm-color-emphasis-100)', padding: '0.25rem 0.5rem', borderRadius: '4px', fontSize: '0.875rem' }}>Liquidity</span>
</div>
</div>
</div>
</a>
...
Need help with any of these tools? Check out our [Community & Support](/guides/resources/community-and-support) page or [FAQ](/guides/resources/faq) for answers to common questions. 
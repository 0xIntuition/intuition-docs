...
await intuition.awardReputation(answer.id, {
  ...
  curveId: reputationCurve.id
            ...
            <ul>
              <li><strong><a href="/docs/getting-started/overview">Quick Start Guide</a></strong>: Get up and running with Intuition</li>
              <li><strong><a href="/docs/getting-started/developer-stack">Developer Tools</a></strong>: Access the tools you need to build</li>
              <li><strong><a href="/docs/intuition-concepts/primitives">Primitives Documentation</a></strong>: Master the building blocks</li>
              <li><strong><a href="/docs/graphql-api/overview">API Reference</a></strong>: Integrate with Intuition's APIs</li>
            </ul>
            ...
            <p>Start with our <a href="/docs/getting-started/overview">Quick Start Guide</a> or explore the <a href="/docs/getting-started/developer-stack">Developer Tools</a> to begin creating your own use case!</p>
          </div>
        </div>
      </main>
    </Layout>

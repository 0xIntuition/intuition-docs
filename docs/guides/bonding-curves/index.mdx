...
⚠️ **Important**: This is purely a display change. Your actual positions and the underlying smart contracts remain unchanged.
...
If you're integrating with the protocol and want help designing your own curve — or understanding which one fits your use case — reach out in our Discord.

...
- [Nested Triples Concept](/docs/guides/core-concepts/primitives/triples/nested-triples)
...
Want to be notified when this tutorial is ready? Join our [Discord](https://discord.gg/intuition) or follow us on [Twitter](https://twitter.com/0xIntuition).

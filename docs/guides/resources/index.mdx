...
<a href="/docs/guides/resources/key-terms" style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
...
<a href="/docs/guides/resources/faq" style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
<div className="uniform-card clickable-card">
...
<a href="/docs/guides/resources/network-health" style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
<div className="uniform-card clickable-card">
...
<a href="/docs/guides/resources/community-and-support" style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
<div className="uniform-card clickable-card">
...
<a href="/docs/guides/resources/utilities" style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
<div className="uniform-card clickable-card">
...
<a href="/docs/guides/resources/audits" style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
<div className="uniform-card clickable-card">

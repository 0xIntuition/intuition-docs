...
sidebar_position: 10
description: Step-by-step guide to discover connected triples and relationship patterns
---
...
Learn how to discover and traverse related claims in the Intuition knowledge graph by exploring triples, their relationships, and semantic connections.

## Understanding the Progression

- **Step 1**: Find all triples where a specific atom appears as subject or object - discover direct relationships
- **Step 2**: Find similar claims by predicate pattern and subject type - discover relationship patterns across the graph
- **Step 3**: Get detailed information for a specific triple including vault metrics and top positions
